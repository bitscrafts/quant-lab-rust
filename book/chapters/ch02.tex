...
\draw[thick, ->] (0,0) -- (5,0) node[right] {\tiny FPR};
\draw[thick, ->] (0,0) -- (0,5) node[above] {\tiny TPR};
\draw[dashed, gray] (0,0) -- (5,5);
\draw[thick, blue] plot[smooth] coordinates {(0,0) (0.3,2) (0.6,3.2) (1,4) (2,4.5) (4,4.9) (5,5)};
\fill[blue!10] plot[smooth] coordinates {(0,0) (0.3,2) (0.6,3.2) (1,4) (2,4.5) (4,4.9) (5,5)} -- (5,0) -- cycle;
